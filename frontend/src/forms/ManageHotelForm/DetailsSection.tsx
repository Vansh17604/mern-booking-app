    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <label className="text-gray-700 text-sm font-bold flex-1">
                    ...
                    {errors.name && (<span className="text-sm text-red-500 font-bold">{errors.name.message}</span>)}
                </label>
                ...
                <label className="text-gray-700 text-sm font-bold flex-1">
                    ...
                    {errors.city && (<span className="text-sm text-red-500 font-bold">{errors.city.message}</span>)}
                </label>
                <label className="text-gray-700 text-sm font-bold flex-1">
                    Country
                    ...
                    {errors.country && (<span className="text-sm text-red-500 font-bold">{errors.country.message}</span>)}
                </label>
                </div>
                <label className="text-gray-700 text-sm font-bold flex-1">
                    Description
                    ...
                    {errors.description && (<span className="text-sm text-red-500 font-bold">{errors.description.message}</span>)}
                </label>
                <label className="text-gray-700 text-sm font-bold max-w-[50%]">
                    ...
                    {errors.pricePerNight && (<span className="text-sm text-red-500 font-bold">{errors.pricePerNight.message}</span>)}
                </label>
                <label className="text-gray-700 text-sm font-bold max-w-[50%]">
                    Star Rating
                    ...
                    {errors.starRating && (<span className="text-sm text-red-500 font-bold">{errors.starRating.message}</span>)}
                </label>
